...
def draw_bar_plot():
  ...
  # Sort DataFrame by 'month' column
    ...
    month_colors = ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet','black','cyan','pink','purple','brown']

    # Draw bar plot
    fig, ax = plt.subplots(figsize=(12,8))
    pivot_df.plot(kind='bar', color=month_colors, ax=ax)
    ax.set_xlabel('Years')
...
def draw_box_plot():
    ...
    sns.boxplot(x='month', y='value', data=df_box, ax=ax[1], palette='pastel', order=month_order)
